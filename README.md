...
├── A1_Name                 # Name of experiment (e.g. 'Sequence_Environment')
    ├── InputData           # VI-SLAM input data generated here
          ├── A1                  # Folder containing sequence configuration data and image timestamps (generated by our script)
                ├── mav0                 # Folder containing input data
                      ├── cam0                 # Folder containing visual data metadata (generated by our script)    
          ...
          └── ...                 # Other settings of virtual environment, such as different light levels (A1_1, A1_2, etc.)
